          ...
          <div className="space-y-8">
            ...
            {showCustomization && (
              ...
              >
                  ...
                  <div className="flex space-x-1 bg-gray-100 p-1 rounded-xl">
                    {[
                      ...
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          switch (tab.id) {
                            ...
                            case 'shape':
                              ...
                              break;
                            case 'frosting':
                              scrollToSection(frostingRef);
                              break;
                            case 'toppings':
                              scrollToSection(toppingsRef);
                              break;
                            case 'color':
                              scrollToSection(colorRef);
                              break;
                            case 'message':
                        ...
                        className={`flex-1 py-3 px-4 rounded-lg text-sm font-medium transition-all ${(tab.id === 'toppings' ? customizations[tab.id]?.length > 0 : customizations[tab.id])
                ...
                <div className="mb-8" ref={sizeRef}>
                  <div className="flex items-center justify-between mb-4">
                ...
                <div className="mb-8" ref={shapeRef}>
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-gray-800 flex items-center">
                      <span className="mr-2">🔷</span>
                      Pick Your Shape
                ...
                <div className="mb-8" ref={frostingRef}>
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-gray-800 flex items-center">
                      <span className="mr-2">🎨</span>
                      Select Frosting
                ...
                <div className="mb-8" ref={colorRef}>
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-gray-800 flex items-center">
                      <span className="mr-2">🌈</span>
                      Choose Custom Color
                ...
                <div className="mb-8" ref={toppingsRef}>
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="text-lg font-semibold text-gray-800 flex items-center">
                      <span className="mr-2">🍓</span>
                      Add Toppings
