...
const FeedbackModal = ({ isOpen, onClose, order, onSubmitFeedback, existingFeedback = null, isEditing = false, isViewOnly = false }) => {
  ...
  }, [isOpen]); // Only depend on isOpen, not existingFeedback
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                      ...
                      <div className="relative inline-block">
                        <div
                          role="button"
                          tabIndex={0}
                          className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 cursor-pointer select-none"
                          onKeyDown={(e) => {
